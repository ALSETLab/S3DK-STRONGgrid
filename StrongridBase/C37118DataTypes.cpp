...
void ConvertRealImagToMagAngle(float real, float imag, float* refMag, float* refAngle )
{
	*refMag = sqrtf(pow(real,2) + pow(imag,2) );
	*refAngle = atanf(imag/real);
}

void ConvertMagAngleToRealImag(float mag, float angle, float* refReal, float* refImag )
{
	*refReal = cos(angle) * mag;
	*refImag = sin(angle) * mag;
}

C37118PmuDataFramePhasorRealImag C37118PmuDataFramePhasorRealImag::CreateByRealImag(int16_t real, int16_t imag)
{
...
C37118PmuDataFramePhasorRealImag C37118PmuDataFramePhasorRealImag::CreateByRealImag(float real, float imag)
{
	C37118PmuDataFramePhasorRealImag ph;
	ph.Real = real;
	ph.Imag	= imag;
...
C37118PmuDataFramePhasorRealImag C37118PmuDataFramePhasorRealImag::CreateByPolarMag(uint16_t magnitude, int16_t angleRad)
{
...
C37118PmuDataFramePhasorRealImag C37118PmuDataFramePhasorRealImag::CreateByPolarMag(float magnitude, float angleRad)
{
	C37118PmuDataFramePhasorRealImag p;
...
void C37118PmuDataFramePhasorRealImag::getRealImagAsFloat(float* refReal, float* refImag) const
{
	*refReal = this->Real;
	*refImag = this->Imag;
}

void C37118PmuDataFramePhasorRealImag::getRealImagAsInt16(int16_t* refReal, int16_t* refImag) const
{
...
void C37118PmuDataFramePhasorRealImag::getMagAngleAsFloat(float* mag, float* angle) const
{
...
C37118PmuDataFrameAnalog C37118PmuDataFrameAnalog::CreateByInt16(int16_t value)
{
